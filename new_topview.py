...
def plot(bkimg,overlay,codeRootdir,date):
    ...
    plt.axis('off')
    path = codeRootdir + "/heatmap/map_topview.png"

    fig.savefig(path, dpi=fig.dpi)

    return path

def run(bkimg, camera_list, camera_det,rootdir, winsize, sigma,date):
    ...
    return plot(bkimg,overlay,rootdir,date)
